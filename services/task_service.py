...
class TaskService:
    def __init__(self):
        ...
        # self.notification_service = NotificationService()  # отключено для сборки
    ...
    def create_task(self, title: str, description: str, priority: Priority, due_date: datetime,
        ...
        # if reminder_time:
        #     self.notification_service.schedule_reminder(task)  # отключено
    ...
    def complete_task(self, task_id: str):
        ...
        if task:
            ...
            # self.notification_service.cancel_reminder(task_id)  # отключено
